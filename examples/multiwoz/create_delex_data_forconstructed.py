...
def createDelexData():
    ...
    fin1 = file('data/standard/hotel/hotel5_constructed.train.json')
    ...
    with open('/data/xyzhang/RL_research_folder/soloist-rl/soloist-cuhk/examples/multiwoz/data/standard/hotel/hotel5_constructed.train.delex.json', 'w') as outfile:
...
def divideData(data):
    ...
    data_no_delex = json.load(open('data/standard/hotel/hotel5_constructed.train.json'))
    # testListFile = []
    ...
    for dialogue_name in tqdm(data):
        ...
        dialogue_act = dialogue_acts[dialogue_name.split('_')[0]]
    ...
    # save all dialogues
    with open('/data/xyzhang/RL_research_folder/soloist-rl/soloist-cuhk/examples/multiwoz/data/standard/hotel/hotel5_constructed.trainforsoloist.json', 'w') as f:
