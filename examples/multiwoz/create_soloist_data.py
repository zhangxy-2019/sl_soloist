...
valid_data = json.load(open('/home/xiaoying/soloist-cuhk/examples/multiwoz/data/standard/train/train44.valid.json'))
# test_data = json.load(open('data/test.json'))
#  = json.load(open('/home/xiaoying/soloist-cuhk/examples/multiwoz/data/standard/restaurant/restaurant5.train_new.soloist.json'))
def write_data_for_internal_v1(data, output_file, output_idx_file):
    ...
    #     for turn in history:
    #         if "user" in turn and "[" in turn:
    #             need_filtered.append(i)
    # print(need_filtered)
    # for num in need_filtered:
    #     examples.remove(example[num])
...
write_data_for_internal_v1(valid_data, '/home/xiaoying/soloist-cuhk/examples/multiwoz/data/standard/train/train44.valid.soloist.json', '/home/xiaoying/soloist-cuhk/examples/multiwoz/data/standard/train/train44.valid.idx.json')
